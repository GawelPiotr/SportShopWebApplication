...
public class AdminList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        getAndForwardAdminProductList(req, resp);
        return;
    }
    ...
    private void getAndForwardAdminProductList(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
